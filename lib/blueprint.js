...
export const BLUEPRINT = [
  ...
  { id: 'card-frames', cat: '通用', name: '卡框 ×4 級（銅/銀/金/紫金）', kind: 'series', folder: 'Card_Frames', aspect: '3:4',
    prompt: '簡報交付②：球員卡金屬框四級，同一形狀四種金屬（金屬階，唔准同現值光彩色階撞色）',
    refPatterns: ['Popup_01_Border', 'Icon_Collectibles_Trophy01_Gold'],
    series: [
      { key: 'bronze', name: '銅框', file: 'Frame_Bronze',
        prompt: 'an ornate portrait trading-card frame border for a kids soccer game: sturdy bronze-copper metal frame with riveted rounded corners and a small soccer ball emblem at the bottom center, the inner window is completely empty with nothing inside the frame' },
      { key: 'silver', name: '銀框', file: 'Frame_Silver', refMode: 'first',
        prompt: 'The exact same card frame with identical shape, ornaments and proportions, re-forged in polished silver metal with a cool chrome shine, inner window still completely empty' },
      { key: 'gold', name: '金框', file: 'Frame_Gold', refMode: 'first',
        prompt: 'The exact same card frame with identical shape, ornaments and proportions, re-forged in radiant golden metal with a warm glow and tiny star sparkles, inner window still completely empty' },
      { key: 'purplegold', name: '紫金框', file: 'Frame_PurpleGold', refMode: 'first',
        prompt: 'The exact same card frame with identical shape, ornaments and proportions, re-forged in legendary purple-gold: iridescent royal-purple metal with bright gold trim and a subtle rainbow sheen, jackpot rarity feel, inner window still completely empty' }
    ] },
  ...
  { id: 'wf-attr-icons', cat: 'WF卡面', name: '六屬性 icon（速盤傳射防力）', kind: 'series', folder: 'WF_Attr_Icons', canvas: 512,
  ...
  { id: 'wf-attr-icons-gk', cat: 'WF卡面', name: 'GK 六屬性 icon', kind: 'series', folder: 'WF_Attr_Icons_GK', canvas: 512,
  ...
  { id: 'wf-line-badges', cat: 'WF卡面', name: 'Line 徽章底板 ×4（GK/BACK/MID/FRONT）', kind: 'series', folder: 'WF_Line_Badges', nine: true,
    prompt: '位置徽章底板，同形四色，文字由引擎壓上去（留空）',
    refPatterns: ['Label_Tapered_Basic', 'Button_Rectangle_01_Convex_Blue'],
    series: [
      { key: 'gk', name: 'GK 底板', file: 'badge_line_gk', prompt: 'a small rounded rectangle badge plate for a kids soccer game, glossy teal with darker teal border, completely blank center for text' },
      { key: 'back', name: 'BACK 底板', file: 'badge_line_back', refMode: 'first', prompt: 'The exact same badge plate with identical shape, now glossy navy blue, blank center' },
      { key: 'mid', name: 'MID 底板', file: 'badge_line_mid', refMode: 'first', prompt: 'The exact same badge plate with identical shape, now glossy green, blank center' },
      { key: 'front', name: 'FRONT 底板', file: 'badge_line_front', refMode: 'first', prompt: 'The exact same badge plate with identical shape, now glossy warm red, blank center' }
    ] },
  { id: 'wf-chip-style', cat: 'WF卡面', name: '風格 chip 底（藍系）', kind: 'ninepatch', file: 'chip_style',
  ...
  { id: 'wf-chip-habit', cat: 'WF卡面', name: '習慣 chip 底（奶白系）', kind: 'ninepatch', file: 'chip_habit',
  ...
  { id: 'wf-slot-skill', cat: 'WF卡面', name: '必殺技 slot 框', kind: 'ninepatch', file: 'slot_skill',
  ...
  { id: 'wf-slot-equip', cat: 'WF卡面', name: '裝備 slot 框', kind: 'ninepatch', file: 'slot_equip',
  ...
  { id: 'wf-stamina-seg', cat: 'WF卡面', name: '體力電池格（着/熄）', kind: 'series', folder: 'WF_Stamina', canvas: 256,
  ...
  { id: 'wf-max-badge', cat: 'WF卡面', name: 'MAX 章', kind: 'single', file: 'badge_max', canvas: 256,
...
export const CATEGORIES = ['通用', 'WF卡面', 'WF圖鑑', '核心道具', '建築', '獎項獎勵', '球星部件', 'UI', '場景'];
