...
export const BLUEPRINT = [
  ...
  { id: 'wf-attr-icons', cat: '卡面套裝', name: '六屬性 icon（速盤傳射防力）', kind: 'series', folder: 'WF_Attr_Icons', canvas: 512,
  ...
  { id: 'wf-attr-icons-gk', cat: '卡面套裝', name: 'GK 六屬性 icon', kind: 'series', folder: 'WF_Attr_Icons_GK', canvas: 512,
  ...
  { id: 'wf-line-badges', cat: '卡面套裝', name: '位置角章 ×4（GK/DEF/MID/FWD，v6 方章）', kind: 'series', folder: 'WF_Line_Badges', canvas: 256,
  ...
  { id: 'wf-chip-style', cat: '卡面套裝', name: '風格 chip 底（藍系）', kind: 'ninepatch', file: 'chip_style',
  ...
  { id: 'wf-chip-habit', cat: '卡面套裝', name: '習慣 chip 底（奶白系）', kind: 'ninepatch', file: 'chip_habit',
  ...
  { id: 'wf-slot-skill', cat: '卡面套裝', name: '必殺技 slot 框', kind: 'ninepatch', file: 'slot_skill',
  ...
  { id: 'wf-slot-equip', cat: '卡面套裝', name: '裝備 slot 框', kind: 'ninepatch', file: 'slot_equip',
  ...
  { id: 'wf-stamina-seg', cat: '卡面套裝', name: '體力電池格（着/熄）', kind: 'series', folder: 'WF_Stamina', canvas: 256,
  ...
  { id: 'wf-max-badge', cat: '卡面套裝', name: 'MAX 章', kind: 'single', file: 'badge_max', canvas: 256,
