...
export const BLUEPRINT = [
  ...
  { id: 'card-frames', cat: '通用', name: '卡框 ×4 級（AI 出 master，銀/金/紫金程式染色 — 保證同形）', kind: 'series', folder: 'Card_Frames', aspect: '3:4',
    prompt: '只生成一個銅框 master，其餘三級確定性衍生：零 API 費、100% 同形、秒出',
    refPatterns: ['gold_open', 'Icon_Collectibles_Trophy01_Gold', 'Popup_01_Border'],
    series: [
      { key: 'bronze', name: '銅框 master（AI）', file: 'Frame_Bronze',
        prompt: 'a chunky ornate portrait trading-card frame for a kids soccer game: THICK rounded bronze-copper metal border with a bold dark outline, glossy cartoon bevel highlights, sturdy riveted corner ornaments, a small soccer ball emblem at the bottom center, strong toy-like metal shine, high polish, the inner window completely empty with nothing inside' },
