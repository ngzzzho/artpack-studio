...
export const BLUEPRINT = [
  ...
  { id: 'wf-attr-icons', cat: '卡面套裝', name: '六屬性彩色 icon（CR 式小插畫）', kind: 'series', folder: 'WF_Attr_Icons', canvas: 512,
    prompt: '多色小插畫 stat icon，主色跟屬性色⠈8組同族、厚黑邊、光澤— Clash Royale 風）',
    refPatterns: ['Icon_Resources_Lightning01_Blue', 'Icon_Resources_Star01_Gold'],
    series: [
      { key: 'speed', name: '速', file: 'attr_speed',
        prompt: 'a colorful cartoon game stat icon: a cyan-blue winged soccer boot with small speed lines, glossy highlights, thick dark outline, chunky and readable at small size' },
      { key: 'dribble', name: '盤', file: 'attr_dribble', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: a purple magical soccer ball with a sparkling swirl around it, glossy, thick dark outline' },
      { key: 'pass', name: '傳', file: 'attr_pass', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: a green curved arrow looping around a small soccer ball, glossy, thick dark outline' },
      { key: 'shoot', name: '射', file: 'attr_shoot', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: a soccer ball comet with orange-red flames trailing, glossy, thick dark outline' },
      { key: 'defend', name: '防', file: 'attr_defend', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: a royal-blue shield with a small soccer ball emblem, glossy, thick dark outline' },
      { key: 'power', name: '力', file: 'attr_power', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: an amber-gold flexed muscular arm, glossy, thick dark outline' }
    ] },
  { id: 'wf-attr-icons-gk', cat: '卡面套裝', name: 'GK 六屬性彩色 icon', kind: 'series', folder: 'WF_Attr_Icons_GK', canvas: 512,
    prompt: 'GK 六數彩色小插畫，同六屬性同族',
    refPatterns: ['Icon_Resources_Lightning01_Blue', 'Icon_Resources_Star01_Gold'],
    series: [
      { key: 'saving', name: 'SAV', file: 'attr_gk_saving',
        prompt: 'a colorful cartoon game stat icon: a cyan-blue goalkeeper glove catching a soccer ball, glossy highlights, thick dark outline, chunky and readable at small size' },
      { key: 'reflexes', name: 'REF', file: 'attr_gk_reflexes', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: a purple wide-open eye with lightning sparks, glossy, thick dark outline' },
      { key: 'rushing', name: 'RUS', file: 'attr_gk_rushing', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: a green dashing goalkeeper figure with speed lines, glossy, thick dark outline' },
      { key: 'handling', name: 'HAN', file: 'attr_gk_handling', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: two orange-red hands safely gripping a soccer ball, glossy, thick dark outline' },
      { key: 'kicking', name: 'KIC', file: 'attr_gk_kicking', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: a royal-blue boot kicking a soccer ball high with an arc line, glossy, thick dark outline' },
      { key: 'positioning', name: 'POS', file: 'attr_gk_positioning', refMode: 'first+auto',
        prompt: 'a colorful cartoon game stat icon in the exact same family: an amber-gold target crosshair over a small goal, glossy, thick dark outline' }
    ] },
